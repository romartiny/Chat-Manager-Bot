...
export declare class Updates {
    ...
    on<P, T = {}>(events: AllowArray<UnsupportedEventContextType | UnsupportedEventContextSubType>, handler: AllowArray<Middleware<UnsupportedEventContext<P> & T>>): this;
    /**
